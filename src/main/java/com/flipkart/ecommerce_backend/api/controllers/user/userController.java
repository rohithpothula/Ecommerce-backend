...
public class userController {
	...
	public ResponseEntity<List<Address>> getAddress(@PathVariable Long userId, @AuthenticationPrincipal LocalUser localuser){
	...
	public ResponseEntity<Address> saveAddress(@PathVariable Long userId, @AuthenticationPrincipal LocalUser localUser, @RequestBody Address address) {
		GenericResponseBody genericResponseBody = new GenericResponseBody();
		if(localUser.getId()==userId) {
			genericResponseBody.setIsSuccess(true);
