...
public enum ErrorCode {
  ...
  TOKEN_NOT_SUPPORTED(
      "TKN-3003", "Token not supported", HttpStatus.BAD_REQUEST), // Changed code to TKN-3003
  TOKEN_ALREADY_VERIFIED(
      "TKN-3004",
      "Verification token already verified",
      HttpStatus.CONFLICT), // Changed code to TKN-3004
  ...
  DATABASE_CONNECTION_ERROR(
      "DB-6003", "Database connection failed", HttpStatus.SERVICE_UNAVAILABLE),
  ...
  ADDRESS_VERIFICATION_FAILED(
      "ADR-9005", "Address verification failed", HttpStatus.INTERNAL_SERVER_ERROR),
