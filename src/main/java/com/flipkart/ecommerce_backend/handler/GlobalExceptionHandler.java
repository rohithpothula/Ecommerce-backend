...
public class GlobalExceptionHandler {
  ...
  /** Handles specific Authentication failures like bad credentials. Returns 401 Unauthorized. */
  ...
  /**
   * Handles authorization failures (user authenticated but lacks permissions). Returns 403
   * Forbidden.
   */
  ...
  public ResponseEntity<ErrorResponse> handleAccessDenied(AuthorizationDeniedException ex) {
    ...
    ErrorResponse errorResponse =
        ErrorResponse.builder()
            ...
            .message(
                "Access Denied: You do not have permission to perform this action or access this resource.") // Clear user message
  ...
  public ResponseEntity<ErrorResponse> handleValidationExceptions(
    ...
    ErrorResponse errorResponse =
        ErrorResponse.of(ErrorCode.VALIDATION_ERROR, "Validation failed", details);
  ...
  public ResponseEntity<ErrorResponse> handleMethodNotSupported(
    ...
    ErrorResponse errorResponse =
        ErrorResponse.of(
            ErrorCode.BAD_REQUEST, String.format("HTTP method '%s' not supported", ex.getMethod()));
