...
public interface UserManagementService extends UserDetailsService {
  /**
   * Registers a new user based on the provided registration details. Checks for existing username
  ...
  /**
   * Finds a user by their username or email and returns their details as a DTO. Excludes sensitive
  ...
  /**
   * Finds a user by their username or email and returns the LocalUser entity. This may include
  ...
  /**
   * Updates an existing user's details. (Potentially Admin Only) Email/username changes should be
   * handled carefully regarding uniqueness. Role changes require appropriate checks.
   *
   ...
   * @throws UserAlreadyExistsException if trying to update email/username to one that already
   *     exists.
   */
  ...
  /**
   * Deletes a user by their ID. (Potentially Admin Only) Consider implications for related data
   * (orders, tokens, etc.).
   *
  ...
  /**
   * Retrieves a list of all users. (Potentially Admin Only) Consider pagination for large datasets
  ...
  /**
   * Retrieves users assigned a specific role. (Potentially Admin Only) Requires Role entity and
   * repository setup.
   *
  ...
  /**
   * [ADMINISTRATIVE] Changes a user's password directly without knowing the old one. Use with
   * extreme caution and secure appropriately. Consider invalidating user sessions/tokens after
   * this.
   *
  ...
  /**
   * [ADMINISTRATIVE] Resets a user's password directly using their email. Bypasses the standard
   * token verification flow. Use with caution. Consider invalidating user sessions/tokens after
   * this.
   *
