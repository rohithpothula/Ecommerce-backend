...
public interface PasswordResetTokenService {
  ...
  /**
   * Creates a unique password reset token for the given user, persists it, and returns the token
   * string.
   *
  ...
  /**
   * Deletes the specified password reset token from the store. Typically called after a successful
   * password reset.
   *
