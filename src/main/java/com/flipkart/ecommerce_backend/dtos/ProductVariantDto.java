...
/** Data Transfer Object representing a specific Product Variant (SKU) for API responses. */
public record ProductVariantDto(
    UUID id, // The unique ID of this specific variant record
    @NotBlank // SKU should always be present
        String sku,
    @NotNull @DecimalMin(value = "0.00") // Price can be zero (e.g., included item) but not negative
        BigDecimal price, // Price specific to this variant
    @NotNull @Min(0) // Quantity cannot be negative
