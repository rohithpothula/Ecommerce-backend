...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    try {
      ...
      // response.sendError(HttpServletResponse.SC_UNAUTHORIZED, e.getMessage()); // Alternative:
      // directly send error
  ...
  /**
   * Extracts the JWT token from the Authorization header. Expects "Bearer <token>".
   *
